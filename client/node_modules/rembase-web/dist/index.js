...
__export(index_exports, {
  ...
  rembaseInitSelfHost: () => rembaseInitSelfHost,
  rembaseInitSync: () => rembaseInitSync
});
...
function rembaseInitSelfHost(appId, selfHostUrl) {
  ...
  var value = {
    login: async (credential) => {
      ...
      if (result.success) {
        ...
        let user = (0, import_jwt_decode.jwtDecode)(result.accessToken);
        return user;
      } else {
  ...
  if (accessToken) {
    let user = (0, import_jwt_decode.jwtDecode)(accessToken);
