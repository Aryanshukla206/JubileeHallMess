...
const RebateManager = () => {
  ...
  return (
    ...
    <div className="bg-white rounded-lg shadow-md overflow-y-auto max-h-96">
      <CollapsibleSection title={"Rebate Applications"}>
        ...
        <div className="border-b border-gray-200">
          <nav className="flex">
            <button
              ...
              className={`px-4 py-3 font-medium text-sm focus:outline-none ${activeTab === 'pending'
            ...
            <button
              ...
              className={`px-4 py-3 font-medium text-sm focus:outline-none ${activeTab === 'approved'
                ? 'border-b-2 border-blue-500 text-blue-600'
                : 'text-gray-500 hover:text-gray-700'
                }`}
            >
