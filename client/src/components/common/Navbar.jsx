          ...
          <div>
            {/* <div className="flex items-center space-x-4">
              <select
                ...
                className={`border rounded-md p-1 ${isLightNavbar ? 'bg-white text-gray-700' : 'bg-blue-700 text-white'}`}
              >
            ...
            <div className="flex items-center md:hidden">
              <button
                ...
                className={`inline-flex items-center justify-center p-2 rounded-md ${isLightNavbar ? 'text-gray-700 hover:bg-gray-100' : 'text-white hover:bg-blue-700'
                  }`}
              >
